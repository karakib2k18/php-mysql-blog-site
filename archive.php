                ...
                <div class="page-wrapper">
                    <div class="blog-custom-build">
                        ...
                        if (isset($_GET['cat_id'])) {
                            ...
                            $posts_display_sql = "SELECT* FROM posts WHERE p_cat = '$post_by_cat' ORDER BY p_id DESC";
                            $posts_display_result = mysqli_query($db, $posts_display_sql);

                            $total_cat_posts = mysqli_num_rows($posts_display_result);

                            if ($total_cat_posts > 0) {
                        ...
                        <?php
                                ...
                                echo '<span class="alert alert-danger bg-alert font-weight-bold "> No Posts In This Catrgory</span>';
                            }
                        }
                        ?>
